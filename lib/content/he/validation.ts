...
export const VALIDATION_HE = {
  ...
  flourTotal: {
    over: "סך הקמחים חורג מ-100%. תרצו שנתקן זאת אוטומטית?",
    under: "סך הקמחים מתחת ל-100%. תרצו שנתקן זאת אוטומטית?",
  },
  calculateBlocked: "תקנו את השדות המסומנים לפני «צור מתכון עכשיו».",
