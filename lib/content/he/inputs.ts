...
export const INPUTS_HE = {
  ...
  fields: {
    ...
    hydration: "כמות נוזלים (הידרציה)",
    hydrationHint:
      "כמה מים יש בבצק ביחס לקמח. בצק נוקשה ≈ 65%, בצק רך מאוד ≈ 80%.",
    inoculation: "כמות המחמצת בבצק (%)",
    salt: "מלח (%)",
    flourPreset: "תערובת מומלצת",
    roomTemp: "טמפרטורת החדר (°C)",
    hoursToAutolyse: "שעות עד מנוחת בצק ראשונית",
    coldRetard: "עיצוב והתפחה במקרר (שעות)",
  ...
  schedule: {
    ...
    subtitle:
      "בחרו שעת סיום אפייה — נבנה לוח זמנים עם האכלת מחמצת, התפחה ואפייה.",
    accordion: {
    ...
    planFooter:
      "התכנון מבוסס על {starter}% מחמצת, {autolyse} שעות עד מנוחה ראשונית, {temp}°C — עדכנו לפי מזג אוויר.",
  ...
  results: {
    emptyTitle: "מוכנים לאפות?",
    emptyBody:
      "מלאו את הנתונים בצד (או בכפתור «התאמה» במובייל) ולחצו «צור מתכון עכשיו» — כאן יופיעו הקמח, המים והמחמצת בגרמים.",
    flour: "קמח",
    water: "מים",
    starter: "מחמצת",
    salt: "מלח",
