...
export const INPUTS_HE = {
  ...
  restMethod: {
    title: "שיטת מנוחה ראשונה",
    autolyse: "אוטוליזה (Autolyse)",
    fermentolyse: "פרמנטוליזה (Fermentolyse)",
    autolyseHint:
      "ערבוב קמח ומים בלבד. מפתח את רשת הגלוטן והופך את הבצק לנוח יותר לעבודה. המחמצת והמלח יוספו לאחר המנוחה.",
    fermentolyseHint:
      "ערבוב קמח, מים ומחמצת יחד (ללא מלח). מתחיל את התסיסה מוקדם במקביל לספיגת המים. חוסך זמן.",
  },
  actions: {
